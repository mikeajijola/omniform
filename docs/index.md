...
- **Founder or operator:** [build the minimal company](getting-started/minimal-company.md), then learn [capabilities and actors](concepts/capabilities-and-actors.md) and [observations](concepts/observations.md).
